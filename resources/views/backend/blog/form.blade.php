...
@section('title', $post->exists ? 'Edit: '.$post->title : 'Create New Blog Post')
...
{!! Form::model($post, [
	...
	<div class="form-group row">
		<div class="col-md-12">{!! Form::label('published_at') !!} </div>

		<div class="col-sm-4">{!! Form::text('published_at', null, ['class' => 'form-control']) !!} </div>
	</div>
	...
	{!! Form::submit($post->exists ? 'Save Blog Post' : 'Create Blog Post', ['class' => 'btn btn-primary']) !!}
	{!!  Form::close() !!}
